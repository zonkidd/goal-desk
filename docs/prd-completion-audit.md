...
| 需求 | 状态 | 说明 |
|------|------|------|
| Calendar Week View | ✅ 完整实现 | 7列网格 + 事件列表 |
...
| Reminders By List | ✅ 完整实现 | 2-4列自适应网格 |
| Reminders By Time | ✅ 完整实现 | 5组折叠/展开 |
