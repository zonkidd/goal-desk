...
本索引整合了 Goal Desk 所有功能的 PRD（Product Requirement Document）和 Spec（Technical Specification）文档。每个功能都包含完整的需求定义、技术实现和设计决策。
...
- **提醒按清单**：2-4列自适应网格排布各清单，支持勾选状态双向同步与隐藏已完成
- **提醒按时间**：已过期/今天/未来7天/更晚/无日期5个分类的折叠与展开分组
